...
if (NOT ANTLR4CPP_JAR_NAME)
    ...
    set(ANTLR4CPP_JAR_NAME antlr-${ANTLR4CPP_EXTERNAL_TAG}-complete.jar)
endif()
...
# Test Antlr tool
message(STATUS "Testing antlr tool...")
execute_process(
    COMMAND           java -cp antlr-4.7.1-complete.jar org.antlr.v4.Tool
    WORKING_DIRECTORY ${ANTLR4CPP_EXTERNAL_ROOT}
    RESULT_VARIABLE   ANTLR4CPP_JAR_TEST_RESULT
    OUTPUT_QUIET
    ERROR_QUIET
    # ENCODING          OEM
)
# if(NOT EXISTS "${ANTLR4CPP_JAR_LOCATION}")
if(ANTLR4CPP_JAR_TEST_RESULT)
    message(STATUS "Test failed: ${ANTLR4CPP_JAR_TEST_RESULT}. Downloading ${ANTLR4CPP_JAR_NAME}...")
    # download Java tool if not installed
    file(
        DOWNLOAD           http://www.antlr.org/download/${ANTLR4CPP_JAR_NAME} ${ANTLR4CPP_JAR_LOCATION}
        INACTIVITY_TIMEOUT 10
        SHOW_PROGRESS
        STATUS ANTLR4CPP_JAR_STATUS
    )
    list(GET ANTLR4CPP_JAR_STATUS 0 ANTLR4CPP_JAR_ERROR_CODE)
    list(GET ANTLR4CPP_JAR_STATUS 1 ANTLR4CPP_JAR_ERROR_MSG)
    # Verify Antlr Available
    if(ANTLR4CPP_JAR_ERROR_CODE)
        message(FATAL_ERROR "Failed to download antlr tool: ${ANTLR4CPP_JAR_ERROR_MSG}")
    endif()
    if(NOT EXISTS "${ANTLR4CPP_JAR_LOCATION}")
        message(FATAL_ERROR "Unable to find ANTLR4CPP_JAR_LOCATION: ${ANTLR4CPP_JAR_LOCATION} -> ${ANTLR4CPP_JAR_NAME} not in ${ANTLR4CPP_EXTERNAL_ROOT} ")
    endif()
endif()
...
ExternalProject_ADD(
    ...
    SOURCE_DIR         ${CMAKE_SOURCE_DIR}/third_party/antlr4
    #--Download step--------------
